...
class SportsNewsTableViewController: UITableViewController , UITabBarControllerDelegate{
    var category = "sports"
    ...
    fileprivate func getNewsInfoFromServer() -> Cancellable {
        return MoyaProvider<NewsAPI>(plugins: [NetworkLoggerPlugin(verbose: true)]).request(.getNewsInfo("Kr", "sports", "04871c167cfb4a3c9c18b9d170d8ba7f")) { result in
            switch result {
